...
import '../../lib_use_case.dart' as _i9;
...
import '../use_case/log_sync_use_case.dart' as _i7;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i7.SyncLoggerUseCase>(
      () => _i7.SyncLoggerUseCaseImpl(get<_i4.SyncRepository>()));
  gh.factory<_i8.SaveAccessTokenUseCase>(() => _i8.SaveAccessTokenUseCaseImpl(
        get<_i4.AccessTokenRepository>(),
        get<_i9.FetchRemoteBooksUseCase>(),
      ));
  return get;
}
