...
class DatabaseV1 {
  static const tableAccessToken = 'CREATE TABLE access_token(token TEXT PRIMARY KEY, is_active INTEGER)';
  ...
  static const tableSyncLog = 'CREATE TABLE sync_log(book_id INTEGER PRIMARY KEY, last_sync)';
}
