...
class DatabaseV1 {
  ...
  static const tableHighlight = 'CREATE TABLE highlight(id INTEGER PRIMARY KEY, text TEXT NOT NULL, note TEXT, location INTEGER NOT NULL, location_type TEXT NOT NULL, highlighted_at TEXT NOT NULL, url TEXT, color TEXT, updated TEXT, book_id TEXT NOT NULL)';
}
